...
public class UpdatePhieuNhap extends javax.swing.JDialog {
    ...
    private void displayInfo() {
        ...
        txtNguoiTao.setText(AccountDAO.getInstance().selectById(phieunhap.getNguoiTao()).getUserName());
        ...
        if (i_row == -1) {
            ...
            if (mtl != null) {
                mtl.setSoLuong(mtl.getSoLuong() + soluong);
                     ...
                     Hang mt =  SearchProduct.getInstance().searchId((String) tblSanPham.getValueAt(i_row, 0));
                     ChiTietPhieu ctp = new ChiTietPhieu(phieunhap.getMaPhieu(), mt.getMaHang(), soluong, mt.getGia());
                     CTPhieu.add(ctp);
              }
         }
            loadDataToTableNhapHang();
