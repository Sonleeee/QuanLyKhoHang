...
public class ThongKeForm extends javax.swing.JInternalFrame {
    ...
    public ThongKeForm() {
        ...
        txtQuantityProduct.setText(Integer.toString(HangDAO.getInstance().getSl()));
    ...
    private void initComponents() {
        ...
        tblThongKeProduct.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã", "Tên", "Số lượng nhập", "Số lượng xuất"
            }
        ));
        ...
        try {
            ...
            for (Account i : acc) {
                tblModelAcc.addRow(new Object[]{
                    i.getFullName(), i.getEmail(), i.getUserName(), i.getRole(), i.getStatus() == 1 ? "Hoạt động" : "Đã khóa"
                });
            }
        } catch (Exception e) {
        }
    ...
    private void loadDataToTableThongKeProduct(ArrayList<ThongKeProduct> thongKe) {
        try {
            ...
            for (int i = 0; i < thongKe.size(); i++) {
                tblModelAcc.addRow(new Object[]{
                    (i + 1), thongKe.get(i).getMaHang(), thongKe.get(i).getTenHang(), thongKe.get(i).getSlNhap(), thongKe.get(i).getSlXuat()
                });
            }
    ...
    private ArrayList<ThongKeProduct> searchTenSanPhamThongKe(ArrayList<ThongKeProduct> arr, String name) {
        ...
        for (ThongKeProduct i : arr) {
            if (i.getMaHang().toLowerCase().contains(name.toLowerCase()) || i.getTenHang().toLowerCase().contains(name.toLowerCase())) {
                result.add(i);
            }
        }
        return result;
