...
public class AddNhaCungCap extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
           ...
           String sdtNcc = txtphone1.getText().trim();
            ...
            if (maNcc.isBlank() || tenNcc.isBlank() || !(isValidPhoneNumber(sdtNcc)) || diachiNcc.isBlank()) {
                JOptionPane.showMessageDialog(this, "Vui lòng kiểm tra lại thông tin!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            } else {
                System.out.println("1");
                System.out.println(NhaCungCapDAO.getInstance().selectById(maNcc));
    ...
    public boolean isValidPhoneNumber(String phoneNumber) {
       return phoneNumber != null && phoneNumber.matches("^0[0-9]{9}$");
    }
